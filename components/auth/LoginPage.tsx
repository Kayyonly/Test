      ...
      <div className="w-full max-w-sm">
        <AnimatePresence mode="wait">
          {step === 'email' ? (
            ...
            >
              <h1 className="text-2xl font-semibold text-white">Masuk ke Vynra Tune</h1>
              <p className="mt-2 text-sm text-gray-400">Login/Register tanpa password dengan verifikasi email.</p>
